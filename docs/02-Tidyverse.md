...
These [neat animations](https://github.com/batpigandme/tidyexplain/tree/pivot) then offer a great illustration of how these joins work and a [cheatsheet by stat545](https://stat545.com/join-cheatsheet.html) summarises this further. After this, I recommend reading three short sections of the relational data chapter in the R for Data Science book: [Understanding joins](https://r4ds.had.co.nz/relational-data.html#understanding-joins), [Inner join](https://r4ds.had.co.nz/relational-data.html#inner-join), [Outer joins](https://r4ds.had.co.nz/relational-data.html#outer-join).
...
[Yet another 'R for Data Science' study guide by Bryan Shalloway](https://brshallo.github.io/r4ds_solutions)  
